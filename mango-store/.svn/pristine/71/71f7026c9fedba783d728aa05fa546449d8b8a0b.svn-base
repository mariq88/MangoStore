...
function mcImgSlider(k) {
    ...
    x.prototype = {k:{c:k.transitionTime,a:function() {
    ...
    var j = new x,b = {a:0,e:"",d:0,c:0,b:0},a,e,s,w,L,G,N,l,n,Q,C,r,A,B,q,U,I,o,h = null,Y = function(b) {
        if (b == "series1")
        ...
        a = {b:k.pauseTime,c:k.transitionTime,f:k.slices,g:k.boxes,O0:k.license || "5432",h:k.hoverPause,i:k.autoAdvance,j:k.captionOpacity,k:k.captionEffect == "none"?0:k.captionEffect == "fade"?1:2,l:k.thumbnailsWrapperId,Ob:function() {
